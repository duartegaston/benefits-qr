  ...
  return (
    <Card className="w-full max-w-md border-surface/80 bg-surface/95 p-6 shadow-xl shadow-border-default/60 sm:bg-surface/85 sm:backdrop-blur-md sm:p-7">
      <div className="mb-6 text-center sm:mb-7">
        <h1 className="mb-1.5 text-2xl font-bold text-text-primary">Editar perfil</h1>
        <p className="text-sm text-text-muted">Estos son los datos que ven tus clientes</p>
      </div>
