...
export default function ShareButtons({ url, descripcion, nombreLocal, fechaExpiracion }: ShareButtonsProps) {
  ...
  return (
    <div className="flex items-center gap-1.5">
      ...
      >
        <svg aria-hidden="true" className="w-4 h-4 text-green-600" viewBox="0 0 24 24" fill="currentColor">
      ...
      >
        {copied ? (
          ...
          <svg aria-hidden="true" className="w-4 h-4 text-violet-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
